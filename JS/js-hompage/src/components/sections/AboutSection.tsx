    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <p className="text-[var(--gold)] font-medium mb-2">ABOUT US</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {coreValues.map((value) => {
            ...
            return (
              ...
              >
                <div className="w-14 h-14 bg-[var(--gold)]/10 rounded-xl flex items-center justify-center mb-6 group-hover:bg-[var(--gold)]/20 transition-colors">
                  <Icon className="w-7 h-7 text-[var(--gold)]" />
                </div>
                <span className="text-[var(--gold)] text-sm font-semibold">
                  {value.number}
                </span>
                <h3 className="text-xl font-bold text-[var(--navy)] mt-1 mb-3">
                  {value.title}
                </h3>
